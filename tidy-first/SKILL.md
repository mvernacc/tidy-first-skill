---
name: tidy-first
description: Apply Tidy First code cleanup techniques and sequencing before behavior changes. Use when users ask to organize or code cleanup, or when a plan from create-plan is provided and the work needs tidying in the code areas that plan will touch.
---
